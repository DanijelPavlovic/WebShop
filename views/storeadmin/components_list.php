<section>
	<div class="container">
		<div class="row">
			...
			<h2 class="title text-center">Components List</h2>
		<?php
					
					
					$this->load->library('table');
					$this->table->set_heading('Component ID', 'Component name', ' Delete', 'Update');
					foreach($komponente as $komponenta)

					$this->table->add_row(	$komponenta['id_komponente'],
										 	$komponenta['component_name'],
										 	'<a href="'.base_url().'Admin/delete_component/'.$komponenta['id_komponente'].'">'.'<button class="btn btn-default add-to-cart">Delete</button>',
										 	'<a href="'.base_url().'Admin/update_component/'.$komponenta['id_komponente'].'">'.'<button class="btn btn-default add-to-cart">Update</button>');
